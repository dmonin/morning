...
goog.provide('morning.validation.EqualityValidator');
 ...
 */
morning.validation.EqualityValidator = function(fieldName, errorMessage, targetField)
{
...
goog.inherits(morning.validation.EqualityValidator, morning.validation.Validator);

/** @inheritDoc */
morning.validation.EqualityValidator.prototype.validate = function(formData)
{
