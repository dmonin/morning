...
goog.provide('monin.validation.ZipcodeValidator');
 ...
 */
monin.validation.ZipcodeValidator = function(fieldName, errorMessage, opt_countries)
{
...
goog.inherits(monin.validation.ZipcodeValidator,
    monin.validation.Validator);

/** @inheritDoc */
monin.validation.ZipcodeValidator.prototype.validate = function(formData)
{
