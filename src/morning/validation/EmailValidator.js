...
goog.provide('morning.validation.EmailValidator');
 ...
 */
morning.validation.EmailValidator = function(fieldName, errorMessage)
{
    goog.base(this, fieldName, errorMessage);

};
goog.inherits(morning.validation.EmailValidator,
    morning.validation.Validator);

/** @inheritDoc */
morning.validation.EmailValidator.prototype.validate = function(formData)
{
