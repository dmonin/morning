...
goog.inherits(monin.ui.Loader, goog.ui.Component);
 ...
 * @return {monin.ui.Loader}
 */
monin.ui.Loader.factory = function(opt_color, opt_diameter)
{
    opt_color = opt_color || '#f2b607';
    opt_diameter = opt_diameter || 30;

    var loader = new monin.ui.Loader();
...
/** @inheritDoc */
monin.ui.Loader.prototype.createDom = function()
{
...
/** @inheritDoc */
monin.ui.Loader.prototype.enterDocument = function()
{
...
/** @inheritDoc */
monin.ui.Loader.prototype.disposeInternal = function()
{
 ...
 * @private
 */
monin.ui.Loader.prototype.initializeLoader_ = function()
{
    if (this.isDisposed())
    {
        return;
    ...
    this.dispatchEvent(monin.ui.Loader.EventType.INITIALIZE);
};
 ...
 * @return {boolean}
 */
monin.ui.Loader.prototype.isInitialized = function()
{
 ...
 * @param {string} color
 */
monin.ui.Loader.prototype.setColor = function(color)
{
    this.color_ = color;
    if (this.cl_)
    {
 ...
 */
monin.ui.Loader.prototype.setDiameter = function(diameter)
{
 ...
 * @param {number} range
 */
monin.ui.Loader.prototype.setRange = function(range)
{
    this.range_ = range;
    if (this.cl_)
    {
 ...
 */
monin.ui.Loader.prototype.setDensity = function(density)
{
 ...
 * @param {number} fps
 */
monin.ui.Loader.prototype.setFps = function(fps)
{
    this.fps_ = fps;
    if (this.cl_)
    {
 ...
 * @param {string} shape
 */
monin.ui.Loader.prototype.setShape = function(shape)
{
    this.shape_ = shape;
    if (this.cl_)
    {
 ...
 * @param {number} speed
 */
monin.ui.Loader.prototype.setSpeed = function(speed)
{
    this.speed_ = speed;
    if (this.cl_)
    {
 ...
 */
monin.ui.Loader.prototype.setVisible = function(isVisible)
{
