...
goog.require('monin.canvas.BoundingBox');
goog.require('monin.canvas.PathParser');

/**
 * @constructor
 */
monin.canvas.SvgPathRenderer = function()
{

};

monin.canvas.SvgPathRenderer.prototype.renderPath = function(ctx, path)
{
    var pathParser = new monin.canvas.PathParser(path);
    pathParser.reset();

    var boundingBox = new monin.canvas.BoundingBox();
    if (ctx != null)
    {
        ctx.beginPath();
    }
