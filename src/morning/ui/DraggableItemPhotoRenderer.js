...
goog.provide('morning.ui.DraggableItemPhotoRenderer');
goog.require('goog.style');
goog.require('morning.ui.IDraggableItemPhotoRenderer');

/**
 * Draggable Item Photo Renderer
 *
 * @constructor
 * @implements {morning.ui.IDraggableItemPhotoRenderer}
 */
morning.ui.DraggableItemPhotoRenderer = function()
{

};

goog.addSingletonGetter(morning.ui.DraggableItemPhotoRenderer);

/**
 * @param {goog.ui.Component} component
 * @return {Element}
 */
morning.ui.DraggableItemPhotoRenderer.prototype.createDom = function(component)
{
 ...
 */
morning.ui.DraggableItemPhotoRenderer.prototype.decorate = function(component, element)
{
