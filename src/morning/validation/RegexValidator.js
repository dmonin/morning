...
goog.provide('morning.validation.RegexValidator');
 ...
 */
morning.validation.RegexValidator = function(fieldName, errorMessage, regex)
{
...
goog.inherits(morning.validation.RegexValidator,
    morning.validation.Validator);

/** @inheritDoc */
morning.validation.RegexValidator.prototype.validate = function(formData)
{
