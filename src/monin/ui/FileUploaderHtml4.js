...
goog.require('monin.ui.FileUploader.EventType');
 ...
 */
monin.ui.FileUploaderHtml4 = function()
{
    goog.base(this);
    ...
    monin.ui.FileUploaderHtml4.instances.set(this.swfId_, this);

};
goog.inherits(monin.ui.FileUploaderHtml4, monin.ui.FileUploader);
 ...
 * @define {string}
 */
monin.ui.FileUploaderHtml4.SWF_PATH = 'assets/swf/uploader.swf';
 ...
 */
monin.ui.FileUploaderHtml4.instances = new goog.structs.Map();


/** @inheritDoc */
monin.ui.FileUploaderHtml4.prototype.decorateInternal = function(el)
{
    goog.base(this, 'decorateInternal', el);

    var swf = new goog.ui.media.FlashObject(monin.ui.FileUploaderHtml4.SWF_PATH);
...
/** @inheritDoc */
monin.ui.FileUploaderHtml4.prototype.enterDocument = function()
{
 ...
 * @private
 */
monin.ui.FileUploaderHtml4.prototype.filesFactory_ = function(fileData)
{
    var files = [];

    for (var i = 0; i < fileData.length; i++)
    {
        files.push(new monin.ui.FileUploader.File(fileData[i]['fileReference']['name'],
 ...
 * @private
 */
monin.ui.FileUploaderHtml4.prototype.handleFileSelect_ = function(e)
{
    this.dispatchEvent({
 ...
 * @param {Object} e
 */
monin.ui.FileUploaderHtml4.prototype.handleSwfEvent = function(e)
{
    switch (e.type)
    {
        case 'swfReady':
 ...
 * @private
 */
monin.ui.FileUploaderHtml4.prototype.handleUploadCompleteData_ = function(e)
{
    try
    {
 ...
 * @private
 */
monin.ui.FileUploaderHtml4.prototype.initialize_ = function()
{
    this.swf_.getFlashElement()['setAllowMultipleFiles'](this.isAllowMultipleFiles_);
};

/** @inheritDoc */
monin.ui.FileUploaderHtml4.prototype.send = function(url, files, opt_data)
{
    try
    {
 ...
 */
monin.ui.FileUploaderHtml4.prototype.setMultiple = function(isMultiple)
{
 ...
 */
monin.ui.FileUploaderHtml4.yuiBridge = function(yId, YUIBridgeCallback, args)
{
    var uploader = monin.ui.FileUploaderHtml4.instances.get(yId);
    uploader.handleSwfEvent(args[1]);
};

goog.exportSymbol('YUI.applyTo', monin.ui.FileUploaderHtml4.yuiBridge);
