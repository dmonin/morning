 ...
 */
goog.provide('morning.net.Socket');
 ...
 */
morning.net.Socket = function(socketUrl)
{
    goog.base(this);
...
goog.inherits(morning.net.Socket, goog.events.EventTarget);

/**
 *
 */
morning.net.Socket.prototype.disconnect = function()
{
 ...
 */
morning.net.Socket.prototype.emit = function(type, opt_data, opt_callback, opt_handler)
{
    if (!this.connected)
    {
 ...
 * @private
 */
morning.net.Socket.prototype.initialize_ = function()
{
    if (goog.DEBUG)
    {
    ...
    this.socket_.on('connect', goog.bind(function() {
        ...
        this.connected = true;
        this.dispatchEvent(morning.net.Socket.EventType.CONNECTED);
    }, this));
    ...
    this.socket_.on('disconnect', goog.bind(function() {
        ...
        this.connected = false;
        this.dispatchEvent(morning.net.Socket.EventType.DISCONNECTED);
    }, this));
};
 ...
 */
morning.net.Socket.prototype.on = function(type, callback, opt_handler)
{
    if (!this.connected)
    {
        throw new Error('Socket not yet connected');
 ...
 */
morning.net.Socket.prototype.off = function(type, callback)
{
    if (!this.connected)
    {
        throw new Error('Socket not yet connected');
 ...
 *
 */
morning.net.Socket.prototype.reconnect = function()
{
    this.socket_.disconnect();
    this.initialize_();
};
