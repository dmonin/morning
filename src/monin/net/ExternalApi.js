 ...
 */
goog.provide('monin.net.ExternalApi');
 ...
 * @constructor
 */
monin.net.ExternalApi = function()
{

};

goog.addSingletonGetter(monin.net.ExternalApi);
 ...
 */
monin.net.ExternalApi.prototype.onAvailable = function(objName, callback, scope)
{
