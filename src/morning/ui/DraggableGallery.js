 ...
 */
goog.provide('morning.ui.DraggableGallery');
 ...
 */
morning.ui.DraggableGallery = function()
{
    goog.base(this);
...
goog.inherits(morning.ui.DraggableGallery, goog.ui.Component);

/**
 * @private
 */
morning.ui.DraggableGallery.prototype.checkDependencies_ = function()
{
...
/** @inheritDoc */
morning.ui.DraggableGallery.prototype.createDom = function()
{
...
/** @inheritDoc */
morning.ui.DraggableGallery.prototype.decorateInternal = function(el)
{
    ...
    var renderer = morning.ui.DraggableItemPhotoRenderer.getInstance();
    var item;
    for (var i = 0; i < images.length; i++)
    {
        item = new morning.ui.DraggableGalleryItem(renderer);
        this.addChild(item);
...
/** @inheritDoc */
morning.ui.DraggableGallery.prototype.enterDocument = function()
{
...
/** @inheritDoc */
morning.ui.DraggableGallery.prototype.getContentElement = function()
{
 ...
 * @private
 */
morning.ui.DraggableGallery.prototype.getPointerPosition_ = function(e)
{
    return morning.events.getPointerPosition(e);
};
 ...
 * @private
 */
morning.ui.DraggableGallery.prototype.handlePointerDown_ = function(e)
{
 ...
 * @private
 */
morning.ui.DraggableGallery.prototype.handlePointerMove_ = function(e)
{
 ...
 * @private
 */
morning.ui.DraggableGallery.prototype.handlePointerUp_ = function(e)
{
    this.stopDragging_();
 ...
 * @private
 */
morning.ui.DraggableGallery.prototype.handleSelectionStart_ = function(e)
{
    e.preventDefault();
    return false;
};
 ...
 * @param {number} t
 */
morning.ui.DraggableGallery.prototype.onAnimationFrame = function(t)
{
 ...
 * @private
 */
morning.ui.DraggableGallery.prototype.startDragging_ = function()
{
 ...
 * @private
 */
morning.ui.DraggableGallery.prototype.stopDragging_ = function()
{
    this.isDragging_ = false;
 ...
 * @private
 */
morning.ui.DraggableGallery.prototype.updateCss_ = function()
{
 ...
 */
morning.ui.DraggableGallery.prototype.updateWidth = function()
{
   var width = 0;
