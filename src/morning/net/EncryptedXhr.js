 ...
 */
goog.provide('morning.net.EncryptedXhr');

goog.require('goog.json');
goog.require('goog.net.XhrIo');
goog.require('morning.crypt.Aes');
 ...
 */
morning.net.EncryptedXhr = function(opt_password)
{
    goog.base(this);
...
goog.inherits(morning.net.EncryptedXhr, goog.net.XhrIo);
 ...
 * @private
 */
morning.net.EncryptedXhr.prototype.encrypt_ = function(data)
{
    if (!morning.net.EncryptedXhr.aes_)
    {
        morning.net.EncryptedXhr.aes_ = new morning.crypt.Aes();
    }

    return morning.net.EncryptedXhr.aes_.encrypt(data, this.password_);
};
 ...
 */
morning.net.EncryptedXhr.send = function(url, opt_callback, opt_method, opt_content,
 ...
 * @override
 */
morning.net.EncryptedXhr.prototype.send = function(url, opt_method, opt_content,
                                         opt_headers)
{
    var jsonContent = '';
    if (goog.isObject(opt_content))
