...
goog.provide('morning.forms.CharacterLimiter');
 ...
 */
morning.forms.CharacterLimiter = function(opt_textArea, opt_maxLength)
{
    goog.base(this);
...
goog.inherits(morning.forms.CharacterLimiter, goog.ui.Component);
 ...
 * @private
 */
morning.forms.CharacterLimiter.prototype.attachListeners_ = function()
{
 ...
 * @private
 */
morning.forms.CharacterLimiter.BASE_CSS_CLASS_ = goog.getCssName('character-limiter');
 ...
 */
morning.forms.CharacterLimiter.prototype.getBaseCssClass = function()
{
    return morning.forms.CharacterLimiter.BASE_CSS_CLASS_;
};

/** @inheritDoc */
morning.forms.CharacterLimiter.prototype.createDom = function()
{
...
/** @inheritDoc */
morning.forms.CharacterLimiter.prototype.decorateInternal = function(el)
{
...
/** @inheritDoc */
morning.forms.CharacterLimiter.prototype.enterDocument = function()
{
 ...
 * @private
 */
morning.forms.CharacterLimiter.prototype.handleBlur_ = function(e)
{
 ...
 * @private
 */
morning.forms.CharacterLimiter.prototype.handleFocus_ = function(e)
{
 ...
 * @private
 */
morning.forms.CharacterLimiter.prototype.handleKeyDown_ = function(e)
{
    var allowedKeys = [
 ...
 * @private
 */
morning.forms.CharacterLimiter.prototype.handleKeyUp_ = function(e)
{
    this.update_();
};
 ...
 * @private
 */
morning.forms.CharacterLimiter.prototype.update_ = function()
{
    if (this.textarea_.value.length >= this.maxLength_)
    {
 ...
 * @private
 */
morning.forms.CharacterLimiter.prototype.output_ = function()
{
...
goog.ui.registry.setDecoratorByClassName(
    'character-limiter',
    function() {
      return new morning.forms.CharacterLimiter();
    });
