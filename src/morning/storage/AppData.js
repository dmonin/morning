...
goog.provide('morning.storage.AppData');
 ...
 */
morning.storage.AppData = function()
{
...
goog.inherits(morning.storage.AppData, goog.storage.ExpiringStorage);

goog.addSingletonGetter(morning.storage.AppData);
