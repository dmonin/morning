goog.provide('morning.ui.Keyboard');
...
goog.inherits(morning.ui.Keyboard, goog.ui.Component);

/** @inheritDoc */
morning.ui.Keyboard.prototype.decorateInternal = function(el)
{
...
/** @inheritDoc */
morning.ui.Keyboard.prototype.enterDocument = function()
{
 ...
 * @private
 */
morning.ui.Keyboard.prototype.handleKey_ = function(e)
{
 ...
 * @param  {number} delay
 */
morning.ui.Keyboard.prototype.hideAfterUse = function(delay)
{
 ...
 */
morning.ui.Keyboard.prototype.setVisible = function(isVisible)
{
