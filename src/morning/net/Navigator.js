...
goog.provide('morning.net.Navigator');
 ...
 */
morning.net.Navigator = function(opt_fetchUrl)
{
    goog.base(this);
...
goog.inherits(morning.net.Navigator, goog.events.EventTarget);

/** @inheritDoc */
morning.net.Navigator.prototype.disposeInternal = function()
{
 ...
 * @private
 */
morning.net.Navigator.prototype.dispatchLoad_ = function()
{
    this.dispatchEvent(morning.net.Navigator.EventType.LOAD_COMPLETE);
};

/**
 * @private
 */
morning.net.Navigator.prototype.dispatchFailure_ = function()
{
    this.dispatchEvent(morning.net.Navigator.EventType.LOAD_FAILURE);
};
 ...
 * @private
 */
morning.net.Navigator.prototype.handleDataLoad_ = function(e)
{
 ...
 * @return {boolean}
 */
morning.net.Navigator.prototype.iframeReady_ = function()
{
 ...
 * @param {string} url
 */
morning.net.Navigator.prototype.navigate = function(url)
{
    this.url = url;
 ...
 * @return {Element}
 */
morning.net.Navigator.prototype.querySelector = function(selector)
{
 ...
 * @return {NodeList}
 */
morning.net.Navigator.prototype.querySelectorAll = function(selector)
{
    return goog.dom.getFrameContentDocument(this.iframe_).querySelectorAll(selector);
};

morning.net.Navigator.EventType = {
