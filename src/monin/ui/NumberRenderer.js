...
goog.provide('monin.ui.NumberRenderer');
 ...
 */
monin.ui.NumberRenderer = function()
{
    goog.base(this);
     ...
     * Animation
     *
     * @type {monin.fx.Animation}
     * @private
     */
    this.animation_ = new monin.fx.Animation([0], [0], 1000, goog.fx.easing.easeOut);
};
goog.inherits(monin.ui.NumberRenderer, goog.ui.Component);

/** @inheritDoc */
monin.ui.NumberRenderer.prototype.enterDocument = function()
{
 ...
 * @private
 */
monin.ui.NumberRenderer.prototype.displayValue_ = function(value)
{
 ...
 * @private
 */
monin.ui.NumberRenderer.prototype.handleAnimation_ = function(e)
{
 ...
 */
monin.ui.NumberRenderer.prototype.setValue = function(value,
    duration)
{
    if (duration)
    {
