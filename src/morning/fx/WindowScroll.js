...
goog.provide('morning.fx.WindowScroll');

goog.require('morning.fx.dom.PredefinedEffect');
 ...
 * @constructor
 */
morning.fx.WindowScroll = function(element, start, end, time, opt_acc) {
...
goog.inherits(morning.fx.WindowScroll, morning.fx.dom.PredefinedEffect);
 ...
 * @override
 */
morning.fx.WindowScroll.prototype.updateStyle = function() {
